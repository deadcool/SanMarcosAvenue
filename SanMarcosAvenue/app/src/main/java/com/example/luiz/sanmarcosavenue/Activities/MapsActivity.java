...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        //Facultad de Ciencias Físicas 2
        mMap.addPolygon(new PolygonOptions()
        ...
        //Puerta 01
        mMap.addCircle(new CircleOptions().center(new LatLng(-12.060963, -77.085899))
            .radius(3).fillColor(Color.BLACK));
        //Puerta 02
        mMap.addCircle(new CircleOptions().center(new LatLng(-12.059520, -77.079284))
            .radius(3).fillColor(Color.BLACK));
        //Puerta 03
        mMap.addCircle(new CircleOptions().center(new LatLng(-12.057087, -77.079937))
            .radius(3).fillColor(Color.BLACK));
        //Puerta 04
        mMap.addCircle(new CircleOptions().center(new LatLng(-12.056099, -77.081152))
            .radius(3).fillColor(Color.BLACK));
        //Puerta 05
        mMap.addCircle(new CircleOptions().center(new LatLng(-12.055073, -77.082546))
            .radius(3).fillColor(Color.BLACK));
        //Puerta 06
        mMap.addCircle(new CircleOptions().center(new LatLng(-12.054371, -77.083818))
            .radius(3).fillColor(Color.BLACK));
        //Puerta 07
        mMap.addCircle(new CircleOptions().center(new LatLng(-12.053486, -77.084720))
            .radius(3).fillColor(Color.BLACK));
        //Puerta 08
        mMap.addCircle(new CircleOptions().center(new LatLng(-12.051787, -77.087656))
            .radius(3).fillColor(Color.BLACK));
        //Puerta 09
        mMap.addCircle(new CircleOptions().center(new LatLng(-12.054030, -77.087724))
            .radius(3).fillColor(Color.BLACK));
    }
